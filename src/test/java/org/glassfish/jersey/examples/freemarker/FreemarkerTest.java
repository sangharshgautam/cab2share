...
public class FreemarkerTest extends JerseyTest {
    ...
    public void testHello() {
        assertTrue(target().path("test/hello").request().get(String.class).contains("Pavel"));
    }

    @Test
    public void testAutoTemplate() {
        assertTrue(target().path("test/autoTemplate").request().get(String.class).contains("Pavel"));
    }

    @Test
    public void testAutoTemplateWithoutSuffix() {
        assertTrue(target().path("test/helloWithoutSuffix").request().get(String.class).contains("Pavel"));
    }
